...
classifier_forest = RandomForest(max_depth=10, criterion_name='entropy', 
                                 random_state=None, num_trees=30)
print("starting" )
start = time.time()
...
accuracy_forest = accuracy_score(y_val, y_val_pred)
print(accuracy_forest)

f1_scoree = f1_score(y_val, y_val_pred)
print(f1_scoree)